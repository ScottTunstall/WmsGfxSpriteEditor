...
namespace WmsGfxSpriteEditor.Sprites
{
    ...
    public record SpriteInfo
    {
        ...
        /// </summary>
        /// <param name="index">The index of the sprite (system generated, not read from ROM)</param>
        ...
        public SpriteInfo(int index, string name, int offset, int widthInBytes, int height, int bitsPerPixel, bool isLinear = true)
        {
            Index = index >= 0 ? index : throw new ArgumentOutOfRangeException(nameof(index), "Index must be a non-negative integer");
